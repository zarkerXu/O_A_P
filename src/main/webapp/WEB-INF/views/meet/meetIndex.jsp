...
<body>
	...
	<div class="docInput-top">
		<ol class="breadcrumb">
		  ...
		  <li class="active"> 已发布会议</li>
		</ol>
	</div>
	<!-- 页面顶部结束 -->

	<!-- 表单开始 -->
	<form id="doselect" action="<c:url value='/meet/meetUser' />" method="post">
   ...
   <div class="modal-dialog docmodel">
      <div class="modal-content">
         <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">
             会议签收情况  <a id="export" href=''><button type="button" class="btn btn-success">导出</button></a>
            </h4>
         </div>
         <div class="modal-body">
             <div class="docmain">
...
$(document).ready(function(){
	$("#meetIndex").css({"background":"#c91306","color":"#ffffff"});
...
function geturl(i,size){
	return  "<c:url value='/meet/meetUser?page=" + i + "&size=" + size + "'/>";
}
function btnsub(){
